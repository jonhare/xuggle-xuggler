...
class JNIManifest {
  ...
  private final static String XUGGLE_APP="Xuggle-Native-App";
  private final static String XUGGLE_ROOT="Xuggle-Native-Root";
  private final static String XUGGLE_PATH="Xuggle-Native-Paths";
  private final static String XUGGLE_BUNDLES="Xuggle-Native-Bundles";
  ...
  public static JNIManifest create(URL url, String appName, Properties props)
  {
    ...
    final String root=props.getProperty(XUGGLE_ROOT);
    final String paths=props.getProperty(XUGGLE_PATH);
    final String bundles=props.getProperty(XUGGLE_BUNDLES);
  ...
  public static JNIManifest create(URL url, String appName, Manifest manifest)
  {
    ...
    final String name = attr.getValue(XUGGLE_APP);
    final String root=attr.getValue(XUGGLE_ROOT);
    final String paths=attr.getValue(XUGGLE_PATH);
    final String bundles=attr.getValue(XUGGLE_BUNDLES);
    return create(url, appName, name, root, paths, bundles);
  }
      ...
      String name, String root, String aPaths, String aBundles)
  {
    ...
    {
      log.trace("{}: no match.  \"{}\" vs \"{}\"", new Object[]{XUGGLE_APP, appName, name});
      return null;
    }
    if (root == null)
      return null;
